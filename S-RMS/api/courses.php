...
if ($method === 'POST') {
    ...
    $stmt = $pdo->prepare('INSERT INTO courses (course_name, course_code, department, credits, instructor, enrolled, schedule) VALUES (:name, :code, :dept, :credits, :instructor, :enrolled, :schedule)');
    $stmt->execute([
